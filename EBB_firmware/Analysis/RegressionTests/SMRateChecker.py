...
for i in range(211764):         # 1hr
    ...
    # This set is the maximum set used in AxiDraw
    ...
    # This set is more typical set used in AxiDraw
    randDuration = int(random.randrange(0, 2000))
    randStep1 = int(random.randrange(-5000,5000))
    randStep2 = int(random.randrange(-5000,5000))
...
#        if diffPercent1 > 0.1 or diffPercent2 > 0.1:
#            print(finalOutStr)
