...
near byte usb_device_state;          // Device States: DETACHED, ATTACHED, ...
near USB_DEVICE_STATUS usb_stat;     // Global USB flags
near byte usb_active_cfg;            // Value of current configuration
near byte usb_alt_intf[MAX_NUM_INT]; // Array to keep track of the current alternate
